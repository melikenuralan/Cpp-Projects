...
void design::welcome_frame()
{
    ...
    for (int c = 1; c <= 10; c++)  //randomly printing "M"
    {
        x = rand() % 70 + 1;
        y = rand() % 20 + 1;
        gotoxy(x, y);
...
void design::oldman(){
	...
	system("cls");
	system("Color 02");
	cout<<"|____________________________________________________|"<<endl; Sleep(1);
	cout<<"| __     __   ____   ___ ||  ____    ____     _  __  |"<<endl; Sleep(1);
	cout<<"||  |__ |--|_| || |_|   |||_|**|*|__|+|+||___| ||  | |"<<endl; Sleep(1);
	cout<<"||==|^^||--| |=||=| |=*=||| |~~|~|  |=|=|| | |~||==| |"<<endl; Sleep(1);
	cout<<"||  |##||  | | || | |C++|||-|  | |==|+|+||-|-|~||__| |"<<endl; Sleep(1);
	cout<<"||__|__||__|_|_||_|_|___|||_|__|_|__|_|_||_|_|_||__|_|"<<endl; Sleep(1);
	cout<<"||_______________________||__________________________|"<<endl; Sleep(1);
	cout<<"| _____________________  ||      __   __  _  __    _ |"<<endl; Sleep(1);
	cout<<"||=|=|=|=|=|=|=|=|=|=|=| __.. / |  |_|  ||#||==|  / /|"<<endl; Sleep(1);
	cout<<"||P|R|O|G|R|A|M|M|I|N|G|/\ \  \\|++|=|  || ||==| / / |"<<endl; Sleep(1);
	cout<<"||_|_|_|_|_|_|_|_|_|_|_/_/\_.___\__|_|__||_||__|/_/__|"<<endl; Sleep(1);
	cout<<"|____________________ /\~()/()~//\ __________________|"<<endl; Sleep(1);
	cout<<"| __   __    _  _     \_  (_ .  _/ _    ___     _____|"<<endl; Sleep(1);
	cout<<"||~~|_|..|__| || |_ _   \ //\\ /  |=|__|~|~|___| | | |"<<endl; Sleep(1);
	cout<<"||--|+|^^|==|1||2| | |__/\ __ /\__| |==|x|x|+|+|=|=|=|"<<endl; Sleep(1);
	cout<<"||__|_|__|__|_||_|_| /  \ \  / /  \_|__|_|_|_|_|_|_|_|"<<endl; Sleep(1);
	cout<<"|_________________ _/    \/\/\/    \_ _______________|"<<endl; Sleep(1);
	cout<<"| _____   _   __  |/      \../      \|  __   __   ___|"<<endl; Sleep(1);
	cout<<"||_____|_| |_|##|_||   |   \/ __|   ||_|==|_|++|_|-|||"<<endl; Sleep(1);
	cout<<"||______||=|#|--| |\   \   o    /   /| |  |~|  | | |||"<<endl; Sleep(1);
	cout<<"||______||_|_|__|_|_\   \  o   /   /_|_|__|_|__|_|_|||"<<endl; Sleep(1);
	cout<<"|_________ __________\___\____/___/___________ ______|"<<endl; Sleep(1);
	cout<<"|__    _  /    ________     ______           /| _ _ _|"<<endl; Sleep(1);
	cout<<"|\ \  |=|/   //    /| //   /  /  / |        / ||%|%|%|"<<endl; Sleep(1);
	cout<<"| \/\ |*/  .//____//.//   /__/__/ (_)      /  ||=|=|=|"<<endl; Sleep(1);
	cout<<"|  \/\|/   /(____|/ //                    /  /||~|~|~|"<<endl; Sleep(1);
	cout<<"|___\_/   /________//   ________         /  / ||_|_|_|"<<endl; Sleep(1);
	cout<<"|___ /   (|________/   |\_______\       /  /| |______|"<<endl; Sleep(1);
	cout<<"    /                  \|________)     /  / | |"<<endl; Sleep(1000);
...
if(count==1)
{
	...
	// NOTE myself* : I'll choose menu options!!
		u.display_menu();
	}
	else
	{
